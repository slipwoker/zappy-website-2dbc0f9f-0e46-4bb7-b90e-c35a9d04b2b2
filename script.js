document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyAnimationStyles() {
    ...
    style.textContent = [
      ...
      '[dir="rtl"] .slide-in { transform: translateX(40px); }',
      '[dir="ltr"] .slide-in { transform: translateX(-40px); }',
      '.slide-in { transform: translateX(-40px); }',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2dbc0f9f-0e46-4bb7-b90e-c35a9d04b2b2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2dbc0f9f-0e46-4bb7-b90e-c35a9d04b2b2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2dbc0f9f-0e46-4bb7-b90e-c35a9d04b2b2';
